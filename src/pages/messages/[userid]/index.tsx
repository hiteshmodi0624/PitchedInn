...
const Messages = () => {
  ...
  return (
    <div
      className="sm:screen sticky top-0 grid h-[94vh] w-full grid-rows-[56px_1fr_max-content] sm:h-screen"
    ...
    >
      ...
      />
      <div className="flex h-full flex-col justify-end space-y-1 overflow-auto p-2">
